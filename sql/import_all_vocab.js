...
for (const c of courses) {
  ...
  for (let i = 0; i < chList.length; i++) {
    ...
    for (const [uname, udesc] of utpls) { units.push([uId++, c[0], chId, uname, udesc]); }
    chId++;
  }
}
...
const lessons = []; let lId = 1;
for (const u of units) { for (let t=0;t<lessonTypes.length;t++) lessons.push([lId++,u[0],u[3]+'-'+typeLabels[lessonTypes[t]],t+1,lessonTypes[t],15]); }
...
const vocabData = [
  ...
  { unit: 27, word: 's', lang: 'zh', pron: '/s/', pos: 'initial', def: '平舌音，舌尖前清擦音', ex: "四(sì)\n颜色(yánsè)" },

  { unit: 28, word: 'ai', lang: 'zh', pron: '/aɪ/', pos: 'compound final', def: '前响复韵母，由a滑向i', ex: "爱好(àihào)\n大海(dà hǎi)" },
  { unit: 28, word: 'ei', lang: 'zh', pron: '/eɪ/', pos: 'compound final', def: '前响复韵母', ex: "妹妹(mèimei)\n北美(běi měi)" },
  { unit: 28, word: 'ao', lang: 'zh', pron: '/ɑʊ/', pos: 'compound final', def: '后响复韵母', ex: "高考(gāokǎo)\n跑步(pǎo bù)" },
  { unit: 28, word: 'ou', lang: 'zh', pron: '/ou/', pos: 'compound final', def: '后响复韵母', ex: "后头(hòutou)\n手(shǒu)" },

  { unit: 29, word: 'an', lang: 'zh', pron: '/an/', pos: 'nasal final', def: '前鼻韵母，舌尖抵住齿龈', ex: "平安(píng ān)\n吃饭(chī fàn)" },
  { unit: 29, word: 'en', lang: 'zh', pron: '/ən/', pos: 'nasal final', def: '前鼻韵母', ex: "认真(rèn zhēn)\n根本(gēn běn)" },
  { unit: 29, word: 'ang', lang: 'zh', pron: '/ɑŋ/', pos: 'nasal final', def: '后鼻韵母，舌根抬起接触软腭', ex: "帮忙(bāng máng)\n上课(shàng kè)" },
  { unit: 29, word: 'eng', lang: 'zh', pron: '/əŋ/', pos: 'nasal final', def: '后鼻韵母', ex: "风(fēng)\n灯(dēng)" },

  { unit: 30, word: '横', lang: 'zh', pron: '/héŋ/', pos: 'n.', def: '基本笔画之一，从左向右平稳书写', ex: "一横一竖\n横平竖直" },
  { unit: 30, word: '竖', lang: 'zh', pron: '/ʂû/', pos: 'n.', def: '基本笔画之一，从上向下垂直书写', ex: "竖着写\n横竖交叉" },
  { unit: 30, word: '撇', lang: 'zh', pron: "/p'iɛ̌/", pos: 'n.', def: '基本笔画，从右上向左下斜出', ex: "一撇一捺\n撇开话题" },
  { unit: 30, word: '捺', lang: 'zh', pron: '/nâ/', pos: 'n.', def: '基本笔画，从左上向右下舒展', ex: "撇捺\n捺脚要稳" },

  { unit: 31, word: '一', lang: 'zh', pron: '/í/', pos: 'numeral', def: '汉字中最简单的字，表示数字1', ex: "一举两得\n一心一意\n一帆风顺" },
  { unit: 31, word: '日', lang: 'zh', pron: '/ɻî/', pos: 'n.', def: '太阳；白天；时间单位"日"', ex: "日出东方\n日日夜夜\n生日快乐" },
  { unit: 31, word: '月', lang: 'zh', pron: '/yüè̌/', pos: 'n.', def: '月亮；月份；时间单位"月"', ex: "月亮弯弯\n一月二月\n月圆之夜" },
  { unit: 31, word: '山', lang: 'zh', pron: '/ʂān/', pos: 'n.', def: '地面形成的高耸的地貌', ex: "高山流水\n上山下山\n山水画" },

  { unit: 32, word: '亻', lang: 'zh', pron: '/rénzìpáng/', pos: 'radical', def: '单人旁，作左偏旁时写作亻', ex: "他们\n伙伴\n位置" },
  { unit: 32, word: '艹', lang: 'zh', pron: '/cǎozìtóu/', pos: 'radical', def: '草字头，表示与植物有关', ex: "花草\n茶叶\n蔬菜" },
  { unit: 32, word: '氵', lang: 'zh', pron: '/sān diǎn shuǐ/', pos: 'radical', def: '三点水，表示与水有关', ex: "江河\n海洋\n游泳" },
  { unit: 32, word: '钅', lang: 'zh', pron: '/jīn zì páng/', pos: 'radical', def: '金字旁，表示与金属有关', ex: "铁锅\n银行\n钥匙" },

  { unit: 33, word: '语', lang: 'zh', pron: '/yǔ̌/', pos: 'n./v.', def: '语言；说话；话语', ex: "汉语\n语文\n语言交流" },
  { unit: 33, word: '思', lang: 'zh', pron: '/sī/', pos: 'v./n.', def: '思考；思念；想法', ex: "思考问题\n思念家乡\n深思熟虑" },
  { unit: 33, word: '学', lang: 'zh', pron: '/xüé́/', pos: 'v./n.', def: '学习；学问；学校', ex: "学习语文\n学无止境\n大学" },
  { unit: 33, word: '好', lang: 'zh', pron: '/hǎo/', pos: 'adj./v.', def: '好；喜爱；容易', ex: "好好学习\n好人好事\n好用" }
];
...
const values = vocabData.map(v =>
  `(${v.unit}, '${esc(v.word)}', '${v.lang}', '${esc(v.pron)}', '${esc(v.pos)}', '${esc(v.def)}', '${esc(v.ex)}', '0')`
);
...
console.log(`Courses: ${courses.length}, Chapters: ${chapters.length}, Units: ${units.length}, Lessons: ${lessons.length}, Vocab: ${vocabData.length}`);
